...
type HallKey = "main" | "ac" | "jungle" | "majlis" | "red";
...
export default function ReserveTable({ open, onClose, occupiedTableIds }: Props) {
                          ...
                          {sec.tables.map(table => {
                            ...
                            return (
                              ...
                              >
                                ...
                                <span className={`text-[9px] flex items-center gap-0.5 ${isOccupied ? "text-[#fb923c]/35" : "text-[#f5f5f0]/35"}`}>
                                  <Users size={9} />
                                  {table.seats}
                                </span>
                              </button>
                ...
                {step === "done" && (
                  ...
                  >
                    ...
                    <p className="text-[#f5f5f0]/50 text-sm leading-relaxed max-w-xs">
                      Your table request for <span className="text-[#c9a84c]">{selectedHall?.name} — {selectedTable?.label}</span> has been sent via WhatsApp. We'll confirm shortly.
                    </p>
                    <button
                      onClick={handleClose}
