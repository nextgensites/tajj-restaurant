...
import { CalendarCheck, ShoppingBag, ShieldCheck } from "lucide-react";
...
function Home() {
  ...
  const { statuses: tableStatuses, bookings, setStatuses: setTableStatuses, refreshStatuses, reserveTable, freeTable, resetAll } = useTableStatuses();
